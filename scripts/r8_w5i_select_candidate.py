...
from nmd.semantic_cross_candidate_binding import CANDIDATES, dev_selection_key
...
def main() -> None:
    ...
    summary = {
        "schema_version": "r8-w5i-selection-receipt-v1",
        "status": "PASS",
