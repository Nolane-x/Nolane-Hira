...
def main() -> None:
    ...
    w5i_vocab = all_w5i_vocab()
    overlap = sorted(w5i_vocab & prior_semantic_vocab())
    if overlap:
        raise RuntimeError(f"W5i vocabulary overlaps W5a-W5h: {overlap}")
    ...
    receipt = {
        "schema_version": "r8-w5i-cache-receipt-v1",
        "status": "PASS",
        "a13_model": A13_MODEL,
        ...
        "w5a_through_w5h_vocab_disjoint": True,
        ...
        "vocab_sha256": list_hash(w5i_vocab),
